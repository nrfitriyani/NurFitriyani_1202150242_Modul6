...
import com.example.android.nurfitriyani_1202150242_modul6.CommentPostActivity;
...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.ViewHolder> {
    ...
    Context context;
    ArrayList<Post> postsList; //array list untuk postlist
...
//menampilkan list data yang di post
    @Override
